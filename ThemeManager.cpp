...
void applyAppTheme(const QString& theme) {
    ...
    if (theme == "dark") {
        qApp->setStyleSheet(
            ...
            "QMenuBar { spacing: 0px; }"
            "QMenuBar::item { padding: 4px 6px; margin: 0px; }"
            "QMenu { background-color: #2c2c2c; color: #ddd; border: 1px solid #555; }"
            "QMenu::item { padding: 6px 4px; }"
            "QMenu::item:selected { background-color: #3d3d3d; }"
            "QMenu::item:disabled { color: #666; }"
            "QMenu::indicator { width: 14px; height: 14px; border: 1px solid #666; background: #333; border-radius: 2px; margin-left: 4px; }"
            ...
            "#themeToggleBtn { background: transparent; border: 1px solid #555; border-radius: 4px; padding: 0px; margin: 3px; }"
        ...
        qApp->setStyleSheet(
            ...
            "QLineEdit { border-radius: 4px; }"
            "QTableWidget { border: 1px solid #9a9a9a; }"
            "QMenuBar { spacing: 0px; }"
            "QMenuBar::item { padding: 4px 6px; margin: 0px; }"
            ...
            "QMenu::indicator { width: 14px; height: 14px; border: 1px solid #999; background: #fff; border-radius: 2px; margin-left: 4px; }"
            "QMenu::indicator:checked { image: url(:/SuperGuardian/check_dark.png); }"
            ...
            "#themeToggleBtn { background: transparent; border: 1px solid #9a9a9a; border-radius: 4px; padding: 0px; margin: 3px; }"
